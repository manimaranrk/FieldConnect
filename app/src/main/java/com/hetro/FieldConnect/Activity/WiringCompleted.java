...
public class WiringCompleted extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wiring_completed);

        updateButton=(Button)findViewById(R.id.wiring_button);

        back=(ImageView)findViewById(R.id.wback);
        ...
        if(preStatus==0 && postStatus==5){

            updateButton.setText("Wiring Completed");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WiringCompleted.this,DashBoardActivity.class);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gps = new GPSTracker1(WiringCompleted.this);
    ...
    public void wmenuButtonClickEvent(View view){

        popupMenu = new PopupMenu(WiringCompleted.this, view);
    ...
    class CheckValidUser extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(WiringCompleted.this);
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            if (networkConnection.isNetworkAvailable()) {
                ...
                pDialog.dismiss();
                Looper.prepare();
                Toast.makeText(WiringCompleted.this,
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    String exit="exit";
                    Intent intent=new Intent(WiringCompleted.this, MainActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
...
//                    startActivity(intent);
//                    finish();
//                    Intent intent= new Intent(WiringCompleted.this, SurveyDataActivity.class);
//                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//                    startActivity(intent);
//                    finish();
