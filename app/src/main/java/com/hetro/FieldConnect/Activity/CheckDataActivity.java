...
public class CheckDataActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(preStatus==0 && postStatus==9){

            updateButton.setText("Check Data");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CheckDataActivity.this,DashBoardActivity.class);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gps = new GPSTracker1(CheckDataActivity.this);
    ...
    public void chmenuButtonClickEvent(View view){
        ...
        popupMenu = new PopupMenu(CheckDataActivity.this, view);
    ...
    class CheckValidUser extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CheckDataActivity.this);
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            if (networkConnection.isNetworkAvailable()) {
                ...
                pDialog.dismiss();
                Looper.prepare();
                Toast.makeText(CheckDataActivity.this,
