...
public class PowerUpSTAYDevice extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.powerup);

        updateButton=(Button)findViewById(R.id.powerup_button);

        back = (ImageView)findViewById(R.id.chback);
        ...
        if(preStatus==0 && postStatus==8){

            updateButton.setText("Power Up STAY Device");
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PowerUpSTAYDevice.this,DashBoardActivity.class);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gps = new GPSTracker1(PowerUpSTAYDevice.this);
    ...
    public void chmenuButtonClickEvent(View view){

        popupMenu = new PopupMenu(PowerUpSTAYDevice.this, view);
    ...
    class CheckValidUser extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(PowerUpSTAYDevice.this);
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            if (networkConnection.isNetworkAvailable()) {
                ...
                pDialog.dismiss();
                Looper.prepare();
                Toast.makeText(PowerUpSTAYDevice.this,
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    String exit="exit";
                    Intent intent=new Intent(PowerUpSTAYDevice.this, MainActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
...
//                            String visitIndex = c.getString(ApplicationConstants.TAG_TOWER_VISIT_INDEX);
                            ...
                            if(approvedBy.equals("1")) {
                                ...
                                Intent intent = new Intent(PowerUpSTAYDevice.this, ApprovalActivity.class);
                                startActivity(intent);
                                finish();
...
//                            Intent intent= new Intent(PowerUpSTAYDevice.this, SurveyDataActivity.class);
//                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
//                            startActivity(intent);
//                            finish();
